# ComboCode — fonti del pack iniziale

Check iniziale: 2026-09-12

## Microsoft Support — Keyboard shortcuts in Windows

https://support.microsoft.com/en-us/windows/keyboard-shortcuts-in-windows-dcc61a57-8ff0-cffe-9796-cb9706c75eec

Usata come fonte primaria per le scorciatoie Windows del pack iniziale.

## Microsoft Learn — Launch Windows Settings

https://learn.microsoft.com/en-us/windows/apps/develop/launch/launch-settings

Usata come fonte primaria per gli URI `ms-settings:`.

## Microsoft Learn — Windows Commands

https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/windows-commands

Usata come riferimento per i comandi della shell Windows.
